...
The basemap tiles require a free [CARTO Basemaps API key](https://carto.com/basemaps/apikey/). Set it as `VITE_CARTO_API_KEY` in your environment (e.g. `.env.local`).
